...
To save time (and money) we're pruning heavily, so we have only extracted frequent itemsets for 2621 artists. If we set `MIN_SUPPORT` lower than 500 we would get more useful data back.
